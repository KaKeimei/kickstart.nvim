...
-- greatest keymap ever, this allows you to paste without yanking the text
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      local parsers = { 'bash', 'c', 'diff', 'go', 'html', 'java', 'json', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'python', 'query', 'toml', 'vim', 'vimdoc', 'yaml' }
